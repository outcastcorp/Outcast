...
### AS OF v4.0.0.0.0.1 ALPHA, OUTCAST'S PREFIX WILL BE CHANGED FROM `Outcast_` TO `outcast_` IN AN EFFORT TO SUPPORT BOTH PREFIXES WORKING.
...
* **Aliases:** `cmds`, `commandlist`, `helpv2`
* **Usage:** `Outcast_help bot`
...
* **Aliases:** `policy`, `privacypolicy`, `privacypolicyv1`
...
### dog
* **Required Bot Permissions:** `EMBED_LINKS`, `ATTATCH_FILES`
* **Description:** 
...
### serverinfo
* **Required Bot Perms:** `EMBED_LINKS`, `ATTACH_FILES`
* **Description:** Get info about a specific server. _**WARNING: FOR PRIVACY REASONS YOU MUST BE IN THE SERVER YOU ARE REQUESTING TO USE THIS.**_
